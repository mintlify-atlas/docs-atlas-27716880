...
<Steps>
  ...
  <Step title="Install frontend dependencies">
    ...
    This installs React 19, pdfjs-dist, Tesseract.js, Framer Motion, Supabase JS client, Tailwind CSS, and the rest of the dependency tree defined in `frontend/package.json`.
  </Step>
...
| `VITE` | Starts the Vite dev server on `http://localhost:5173` |
...
|---|---|---|
| `dev` | `vite` | Starts the Vite dev server on port 5173 |
