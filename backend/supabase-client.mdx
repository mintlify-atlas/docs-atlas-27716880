---
title: "Supabase Client Service — Database and Auth Reference"
sidebarTitle: "Supabase Client"
description: "Reference for all database operations, authentication helpers, and the AI Edge Function caller exported from supabaseClient.ts in Inforario."
---
...
Fetches lightweight schedule summaries for a user — excludes the full `schedule_data` blob to keep list views fast. The returned objects are **partial rows**, not full `DBResponseSchedule` shapes.
