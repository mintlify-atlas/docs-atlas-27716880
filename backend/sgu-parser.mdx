---
title: "SGU Schedule Parser — Local PDF and Image Parser Reference"
sidebarTitle: "SGU Parser"
description: "Reference for parseScheduleFile and resolveConflicts exported from sguRegexParser.ts — Inforario's local, zero-network UTM schedule parser."
---
...
`ParseResult` is the local return type for parser output. `ClassSession` is imported from `types/sgu.ts` — see the [Types Reference](/backend/types-reference) page for its full field documentation.
