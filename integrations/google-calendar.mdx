---
title: "Sync Your UTM Schedule to Google Calendar – Inforario"
...
<AccordionGroup>
  <Accordion title="Return values">
    ...
    <ResponseField name="initializeGoogleApi" type="() => Promise<void>">
    ...
    <ResponseField name="syncScheduleToCalendar" type="(schedule, semesterStart, semesterEnd) => Promise<SyncResult>">
  ...
  <Accordion title="RRULE format in this path">
  ...
  <Accordion title="Required environment variable">
